...
assert "BRIDGE_BUILD = '322.3.2'" in site
...
assert "versionName '322.3.2'" in gradle
...
assert 'android:icon="@mipmap/subhub_launcher_32232"' in manifest
assert 'android:roundIcon="@mipmap/subhub_launcher_32232"' in manifest
...
assert (root/'app/src/main/res/mipmap-anydpi-v26/subhub_launcher_32232.xml').exists()
